    ...
    return (
        <div className="max-w-6xl mx-auto px-6 py-4 font-sans text-sm">
            ...
            <div className="flex items-center justify-between border-b pb-4 mb-6">
                <h1 className="text-xl font-semibold text-gray-800">Organisation Profile</h1>
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-12 gap-8">
                    <div className="col-span-12 md:col-span-3">
                        <label className="block text-[13px] text-gray-600 mb-1">Organisation Logo</label>
                    </div>
                    <div className="col-span-12 md:col-span-9 flex items-start gap-4">
                        <div className="w-40 h-24 border border-dashed border-gray-300 bg-gray-50 rounded flex flex-col items-center justify-center text-gray-400 cursor-pointer hover:border-gray-400 transition-colors">
                            ...
                            <span className="text-[10px] uppercase font-semibold tracking-wide">Upload Logo</span>
                        </div>
                        <div className="text-[11px] text-gray-500 space-y-1">
                            <p>This logo will be displayed on documents such as Payslip and TDS Worksheet.</p>
                            <p>Preferred Image Size: 240 x 240 pixels @ 72 DPI, Maximum size of 1MB.</p>
                ...
                <div className="grid grid-cols-12 gap-8">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <input
                            ...
                            placeholder="Kayaa Electronics Pvt Ltd"
                        />
