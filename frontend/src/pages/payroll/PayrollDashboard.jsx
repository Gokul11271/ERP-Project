...
const PayrollDashboard = () => {
    ...
    if (loading) return <div className="p-8 flex justify-center">Loading Dashboard...</div>;

    return (
        <div className="p-8 bg-gray-50 min-h-screen">
            <h1 className="text-2xl font-semibold text-gray-800 mb-6">Welcome sales!</h1>
            ...
            <div className="flex gap-6">
                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4">Upcoming Payrun</h2>
                        <div className="bg-gray-50 rounded-lg p-6 border border-gray-100 flex justify-between items-center">
                            <div>
                                <div className="flex items-center gap-2 mb-4">
                                    <h3 className="text-gray-700 font-medium text-lg">Process Pay Run for {currentMonthName} {currentYear}</h3>
                                    <span className="px-2 py-0.5 bg-gray-200 text-gray-600 text-xs font-bold rounded">DRAFT</span>
                                </div>

                                <div className="flex gap-12">
                                    <div>
                                        <p className="text-xs text-gray-500 mb-1">Employees' Net Pay</p>
                                        <p className="text-xl font-bold text-gray-800">{formatCurrency(totalMonthlyPay)}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium text-gray-800">{activeEmployees.length}</p>
                                    </div>
                                </div>

                                <div className="mt-4 flex items-center gap-1 text-xs text-orange-500">
                                    <span className="w-4 h-4 rounded-full border border-orange-500 flex items-center justify-center">!</span>
                                    This payment is overdue by 32 day(s).
                                </div>
                            </div>

                            <Link to="/payroll/run" className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded hover:bg-blue-700 transition">
                                View Details
                            </Link>
                        </div>
                        <div className="mt-3">
                            <Link to="#" className="text-sm text-blue-600 hover:underline">View 1 More →</Link>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        ...
                        <div className="col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-gray-700 font-medium">Benefits and Deductions</h2>
                        ...
                        <div className="col-span-1 bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center justify-center">
                            <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-8 w-full text-left">Employee Summary</h2>
                            <div className="text-center">
                                <p className="text-xs text-gray-500 font-bold mb-2">ACTIVE EMPLOYEES <span className="text-orange-500 ml-1">!</span></p>
                                <p className="text-6xl font-light text-green-600 mb-8">{activeEmployees.length}</p>
                                <Link to="/payroll/employees" className="text-sm text-blue-600 hover:underline">View Employees</Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-gray-700 font-medium">Payroll Cost Summary</h2>
                            <select className="text-xs border-gray-300 rounded text-gray-500 bg-transparent">
                ...
                <div className="w-80">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 h-full min-h-[400px]">
                        ...
                        <div className="flex flex-col items-center justify-center text-center mt-8">
                            ...
                            <h3 className="text-lg font-medium text-gray-800 mb-2">Time to celebrate!</h3>
